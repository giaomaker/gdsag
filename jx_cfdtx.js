...
[task_local]
#京喜财富岛提现
59 11,12,23 * * * jx_cfdtx.js, tag=京喜财富岛提现, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true
================Loon==============
[Script]
cron "59 11,12,23 * * *" script-path=jx_cfdtx.js,tag=京喜财富岛提现
===============Surge=================
京喜财富岛提现 = type=cron,cronexp="59 11,12,23 * * *",wake-system=1,timeout=3600,script-path=jx_cfdtx.js
============小火箭=========
京喜财富岛提现 = type=cron,script-path=jx_cfdtx.js, cronexpr="59 11,12,23 * * *", timeout=3600, enable=true
 */
