...
[task_local]
#来电好物季
35 8 * * * jd_ldhwj.js, tag=来电好物季, img-url=https://raw.githubusercontent.com/Orz-3/task/master/jd.png, enabled=true

================Loon==============
[Script]
cron "35 8 * * *" script-path=jd_ldhwj.js, tag=来电好物季

===============Surge=================
来电好物季 = type=cron,cronexp="35 8 * * *",wake-system=1,timeout=3600,script-path=jd_ldhwj.js

============小火箭=========
来电好物季 = type=cron,script-path=jd_ldhwj.js, cronexpr="35 8 * * *", timeout=3600, enable=true

 */
const $ = new Env('来电好物季');
//Node.js用户请在jdCookie.js处填写京东ck;
const jdCookieNode = $.isNode() ? require('./jdCookie.js') : '';
let appId = '1E1NYw6w' , homeDataFunPrefix = 'healthyDay', collectScoreFunPrefix = 'harmony', message = ''
