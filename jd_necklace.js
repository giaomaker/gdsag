...
[task_local]
#点点券
10 0-23/4 * * * jd_necklace.js, tag=点点券, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
================Loon==============
[Script]
cron "10 0-23/4 * * *" script-path=jd_necklace.js,tag=点点券
===============Surge=================
点点券 = type=cron,cronexp="10 0-23/4 * * *",wake-system=1,timeout=3600,script-path=jd_necklace.js
============小火箭=========
点点券 = type=cron,script-path=jd_necklace.js, cronexpr="10 0-23/4 * * *", timeout=3600, enable=true
 */
const $ = new Env('点点券');
let allMessage = ``;
