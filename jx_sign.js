...
[task_local]
#京喜签到
20 0 * * * jx_sign.js, tag=京喜签到, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "20 0 * * *" script-path=jx_sign.js,tag=京喜签到

===============Surge=================
京喜签到 = type=cron,cronexp="20 0 * * *",wake-system=1,timeout=3600,script-path=jx_sign.js

============小火箭=========
京喜签到 = type=cron,script-path=jx_sign.js, cronexpr="20 0 * * *", timeout=3600, enable=true
 */
