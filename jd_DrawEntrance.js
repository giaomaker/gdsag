...
============Quantumultx===============
[task_local]
30 7 * * * jd_DrawEntrance.js, tag=天天优惠大乐透,  enabled=true
================Loon==============
[Script]
cron "30 7 * * *" script-path=jd_DrawEntrance.js,tag=天天优惠大乐透
===============Surge=================
天天优惠大乐透 = type=cron,cronexp="30 7 * * *",wake-system=1,timeout=3600,script-path=jd_DrawEntrance.js
============小火箭=========
天天优惠大乐透 = type=cron,script-path=jd_DrawEntrance.js, cronexpr="30 7 * * *", timeout=3600, enable=true
 */
