...
[task_local]
#京喜领88元红包
30 1,6,21 * * * jx_lhb.js, tag=京喜领88元红包, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
==============Loon==============
[Script]
cron "30 1,6,21 * * *" script-path=jx_lhb.js,tag=京喜领88元红包
================Surge===============
京喜领88元红包 = type=cron,cronexp="30 1,6,21 * * *",wake-system=1,timeout=3600,script-path=jx_lhb.js
===============小火箭==========
京喜领88元红包 = type=cron,script-path=jx_lhb.js, cronexpr="30 1,6,21 * * *", timeout=3600, enable=true
 */
