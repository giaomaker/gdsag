...
[task_local]
#京喜领88元红包
15 0,10,13 * * * jx_lhb.js, tag=京喜领88元红包, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

==============Loon==============
[Script]
cron "15 0,10,13 * * *" script-path=jx_lhb.js,tag=京喜领88元红包

================Surge===============
京喜领88元红包 = type=cron,cronexp="15 0,10,13 * * *",wake-system=1,timeout=3600,script-path=jx_lhb.js

===============小火箭==========
京喜领88元红包 = type=cron,script-path=jx_lhb.js, cronexpr="15 0,10,13 * * *", timeout=3600, enable=true
 */
...
!(async () => {
    ...
    console.log('京喜领88元红包\n' +
        ...
        '温馨提示：如提示助力火爆，可尝试寻找京东客服')
    let res = [
        "sA0J0amfPeyFqzbgvE-y2nAyqzEBOABcHBpYkDXEyH0",
        "sA0J0amfPeyFqzbgvE-y2jGU2_hNfArvYVxYlQ_C96d1Ffe2U484vy5GrKcjlRVW",
        "sA0J0amfPeyFqzbgvE-y2m4C-aLcD37osoYmEU5TTcCFHQPaIBMkf8ikVff0rKRs",
    ]
